...
class MassMarkupContext extends MarkupContext
{
  ...
  public function iShouldSeeTheCorrectMarkupForTheFooter()
  {
    ...
    $this->assertRegionElement('.ma__footer-new__content > nav', 'footer');
    $this->assertRegionElement('.ma__footer-new__logo', 'footer');
    $this->assertRegionElement('.ma__footer-new__content > .ma__footer-new__copyright', 'footer');
  }
