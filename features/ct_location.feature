...
Feature: Location Landing Page Content type
  ...
  Scenario: Verify that the location content type displays it's content correctly
    ...
    And I should see the link "Reserve a Campsite" in the "page_header" region
    And I should see the link "Download a Park Map" in the "page_header" region
    And I should see the link "Download a Trail Map" in the "page_header" region
