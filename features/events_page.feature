...
Feature: Organization Events Page
  ...
  Scenario: Verify that the events pages display past and upcoming events.
    ...
    Then I should not see "Upcoming Events from Events Test Org"
    And I should not see "See past events"
    And I should not see "See all events"
    ...
    Given I am on "/orgs/events-test-org"
    Then I should see "Upcoming Events from Events Test Org"
    And I should see "No upcoming events scheduled"
