...
function fetchTypes(alias) {
  var query = "SELECT type FROM node_field_data WHERE type NOT IN ('action', 'contact_information', 'fee', 'person', 'decision_tree_branch', 'decision_tree_conclusion') AND status = 1 GROUP BY type"
