...
/**
 * Provides a plugin for the 'schema_special_announcement_getting_tested_info' meta tag.
 *
 ...
 * )
 */
class SchemaSpecialAnnouncementGettingTestedInfo extends SchemaUrlWebContentBase {
