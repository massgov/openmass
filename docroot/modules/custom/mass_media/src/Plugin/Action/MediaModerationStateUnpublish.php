 ...
 * )
 */
class MediaModerationStateUnpublish extends ActionBase {
  ...
  public function execute(MediaInterface $entity = NULL) {
    if ($entity) {
      ...
      $entity->setRevisionLogMessage('Moderation state for media entity ' . $entity->id() . ' changed by bulk action to Unpublished.');
