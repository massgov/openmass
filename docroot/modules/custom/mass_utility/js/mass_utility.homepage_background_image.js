...
(function ($, drupalSettings) {
  ...
  $('#GUID935283478').each(function () {
    ...
    $(this).append(
      '<div class="ma__search-banner__image-credit">' +
      '  <div class="ma__search-banner__credits-container">' +
      '    <div class="ma__search-banner__icon">' +
      ...
      '    </div>' +
      '    <div class="ma__search-banner__image-name">' + image.image_location + '</div>' +
      '    <div class="ma__search-banner__image-author">' + image.image_credit + '</div>' +
      '  </div>' +
      '</div>'
    );
  });
