...
class ListLongLabelDocumentSelfReportedAccessibilityStatusWidget extends ListLongLabelWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['#attributes']['class'][] = 'js-accessibility-status-field';
  ...
  protected function getEmptyLabel() {
    if (!$this->required && !$this->multiple) {
      return new FormattableMarkup('<small><strong>TBD:</strong><br/> You can\'t publish this document unless you choose one of the other states.</small>', []);
    }
  }
