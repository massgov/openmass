...
class FilterRichtextIndent extends FilterBase {
  ...
  public function process($text, $langcode) {
    ...
    // $tableId = uniqid();
    $tableWrapperTop = '<table>';
    //'<div class="ma__rich-text__indent ma__table--responsive js-ma-responsive-table" data-ma-heading-parent="H' . $parentHeadingNum . '">
