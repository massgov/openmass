...
class UnpublishReminderQueue extends QueueWorkerBase {
  ...
  public function processItem($nid) {
    ...
    if (!empty($author)) {
      ...
      $params['message'] = t("A Promotional page or Alert that you or someone in your organization authored has an unpublish date that will arrive soon. At that time, the content will be unpublished.\n\rPage: :page_url\nUnpublish date: @unpublish_date\n\rIf you want to keep the page or alert, please review it, check its performance, and update it if necessary. You can then update the unpublish date.\n\rIf you no longer need a Promotional page or Alert, you can let it unpublish automatically or you can unpublish it manually now. If you think there could still be traffic to the Promotional page, please make a ServiceNow ticket to redirect that traffic to an appropriate page.\n\rIf you have any questions, please make a ServiceNow request.\n\nThank you.",
        [
