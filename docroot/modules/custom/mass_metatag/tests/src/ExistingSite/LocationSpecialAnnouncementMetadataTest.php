...
class LocationSpecialAnnouncementMetadataTest extends MetadataTestCase {
  ...
  public function getContent(): ContentEntityInterface {
    ...
    $node = $this->createNode([
      ...
      'moderation_state' => 'published',
      'field_location_metatags' => serialize([
        ...
        'schema_special_announcement_school_closures_info' => serialize([
          '@type' => 'WebSite',
          '@id' => 'http://schema.org',
          'name' => 'test',
          'url' => 'http://schema.org',
        ...
        'schema_special_announcement_location' => serialize([
          '@type' => 'CivicStructure',
          'name' => 'test',
          'url' => 'http://schema.org',
          'address' => [
        ...
        'schema_special_announcement_getting_tested_info' => serialize([
          '@type' => 'WebPageElement',
          '@id' => 'http://schema.org',
          'name' => 'test',
          'url' => 'http://schema.org',
        ...
        'schema_special_announcement_disease_spread_statistics' => serialize([
          '@type' => 'WebSite',
          '@id' => 'http://schema.org',
          'name' => 'test',
          'url' => 'http://schema.org',
        ...
        'schema_special_announcement_spatial_coverage' => serialize([
          '@type' => 'State',
          'name' => 'test',
          'url' => 'http://schema.org',
          'address' => [
        ...
        'schema_special_announcement_disease_prevention_info' => serialize([
          '@type' => 'WebPage',
          '@id' => 'http://schema.org',
          'name' => 'test',
          'url' => 'http://schema.org',
