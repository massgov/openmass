 ...
 */
if (!$cli && !$is_prod && !in_array($_SERVER['SERVER_NAME'], ['massgovdev.prod.acquia-sites.com', 'wwwcf.digital.mass.gov', 'editcf.digital.mass.gov', 'stage.mass.gov', 'edit.stage.mass.gov'])) {
